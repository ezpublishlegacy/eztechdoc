...
eZ Publish Platform 5.x : Persistence cache
===========================================

Created and last modified by andre.romcke@ez.no on Nov 17, 2013
...
-  `Persistent cache <#Persistencecache-Persistentcache>`__
   ...
   -  `What is cached? <#Persistencecache-Whatiscached?>`__
   -  `Legacy kernel cache
