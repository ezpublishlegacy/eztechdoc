...
eZ Publish Platform 5.x : The Page FieldType
============================================

Created by jerome.vieilledent@ez.no, last modified by
sarah.haim-lubczanski@ez.no on Dec 12, 2014
...
-  `Rendering blocks <#ThePageFieldType-Renderingblocks>`__
   ...
   -  `Using ez\_page:viewBlock <#ThePageFieldType-Usingez_page:viewBlock>`__
   ...
   -  `Using
      pageView:viewBlockById <#ThePageFieldType-UsingpageView:viewBlockById>`__

      -  `Available
         arguments <#ThePageFieldType-Availablearguments.1>`__
...
`See field rendering
documentation <Content-view_8323263.html#Contentview-Contentview-UsingtheFieldType'stemplateblock>`__
...
You can render Blocks with ESI strategy in all contexts, ie including
using Varnish with the controller viewBlockById.
...
| The block ID of the block you want to render
| A ``\eZ\Publish\API\Repository\Exceptions\NotFoundException`` will be
thrown, if block could not be found
...
|                                                                          |
| *``template: ``\ ``"AcmeDemoBundle:page/zonelayouts/my_template.html.twi |
| g"``*                                                                    |
|                                                                          |
...
|                                                                          |
|                                                                          |
| |image10| Posted by desorden at May 07, 2013 07:01                       |
+--------------------------------------------------------------------------+
...
|     template: "AcmeDemoBundle:page/zonelayouts:my_template.html.twig"    |
|                                                                          |
| |image11| Posted by jerome.vieilledent@ez.no at May 07, 2013 07:49       |
+--------------------------------------------------------------------------+
| Thanks Jerome. Now i know what it wasn't working for me last             |
| night \ |(smile)|                                                        |
|                                                                          |
| |image12| Posted by desorden at May 07, 2013 07:50                       |
+--------------------------------------------------------------------------+
...
| Thanks                                                                   |
| |image13| Posted by desorden at May 08, 2013 20:45                       |
+--------------------------------------------------------------------------+
| You're right Carlos, fixing.                                             |
|                                                                          |
| |image14| Posted by jerome.vieilledent@ez.no at May 08, 2013 20:52       |
+--------------------------------------------------------------------------+
...
|                                                                          |
| |image15| Posted by gaetano.giunta@ez.no at Jan 24, 2014 14:20           |
+--------------------------------------------------------------------------+
| Guys, are you sure that block object is passable with render\_esi ? via  |
| GET on fragment url?                                                     |
|                                                                          |
| Check this                                                               |
| out: \ `http://blogs.arondor.com/en/Content-management/Error-during-load |
| ing-of-an-eZ-Flow-landing-page-with-eZ-Publish-5-on-PROD <http://blogs.a |
| rondor.com/en/Content-management/Error-during-loading-of-an-eZ-Flow-land |
| ing-page-with-eZ-Publish-5-on-PROD>`__                                   |
|                                                                          |
| Looks to me there should be a possibility to pass only block id...       |
|                                                                          |
| |image16| Posted by gof at Jun 15, 2014 06:51                            |
+--------------------------------------------------------------------------+
| You're right Ivo. Fixing                                                 |
|                                                                          |
| |image17| Posted by jerome.vieilledent@ez.no at Jun 16, 2014 07:56       |
+--------------------------------------------------------------------------+
| I think it would be useful to give an example of custom controller for a |
| block because it's a little tricky and not so simple as a custom         |
| controller used to display a simple location.                            |
|                                                                          |
| The built in controller with the page service only fetches contents      |
| ordering them by priority. That's limited. I wanted to reproduce the     |
| fetchClass property in legacy ezflow.                                    |
|                                                                          |
...
|                                                                          |
| It needs to extends                                                      |
| eZ\\Publish\\Core\\MVC\\Symfony\\Controller\\Controller class and it's   |
| constructor must have to parameters the ViewManager that will help       |
| display the block and the PageService.                                   |
|                                                                          |
...
|                                                                          |
|     services:                                                            |
|         mydev.controller.page.view:                                      |
|             class: MyOwnBundle\Controller\BlockController                |
|             arguments: [@ezpublish.view_manager, @ezpublish.fieldType.ez |
| page.pageService]                                                        |
...
|         my_group:                                                        |
|             latest_content:                                              |
|                 template: MyOwnBundle:block:latest_content.html.twig     |
|                 controller: mydev.controller.page.view:viewContentListBl |
| ock                                                                      |
|                 match:                                                   |
|                     Type: LatestContents                                 |
|                                                                          |
|                                                                          |
|                                                                          |
| And there we go to the controller itself that you have to place in the   |
| controller folder of your bundle.                                        |
|                                                                          |
| **Controller**                                                           |
| .. code:: theme:                                                         |
|                                                                          |
|     namespace MyOnwBundle\Controller;                                    |
|     use eZ\Bundle\EzPublishCoreBundle\FieldType\Page\PageService;        |
|     use eZ\Publish\Core\FieldType\Page\Parts\Block;                      |
|     use Symfony\Component\HttpFoundation\Response;                       |
|     use eZ\Publish\Core\MVC\Symfony\View\Manager as ViewManager;         |
|     use eZ\Publish\Core\MVC\Symfony\Controller\Controller as BaseControl |
| ler;                                                                     |
|                                                                          |
...
|                                                                          |
|         public function __construct( ViewManager $viewManager, PageServi |
| ce $pageService )                                                        |
|         {                                                                |
...
|         * @return Response                                               |
|         */                                                               |
|         public function viewContentListBlock( Block $block, array $param |
| s = array(), array $cacheSettings = array() )                            |
|         {                                                                |
|             $validItems = array();                                       |
|              /*                                                          |
|               do your own business here to set the $validItems           |
|              */                                                          |
...
|                   )                                                      |
|                 {                                                        |
|                     $response->setSharedMaxAge( (int)$cacheSettings['sma |
| x-age'] );                                                               |
|                 }                                                        |
|                 if (                                                     |
...
|                                                                          |
| |image18| Posted by jlchassaing at Feb 03, 2015 09:03                    |
+--------------------------------------------------------------------------+
