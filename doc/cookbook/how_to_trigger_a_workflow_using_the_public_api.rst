...
eZ Publish Platform 5.x : How-to trigger a workflow using the Public API
========================================================================
...
|                                                                          |
| you have to use the ``eZOperationHandler::execute``\ () call using both  |
| a different operation name and different parameters. The quickest way to |
| see all available legacy operations and the parameters they expect is    |
| probably to install the legacy extension                                 |
| `ggsysinfo <http://projects.ez.no/ggsysinfo>`__                          |
|                                                                          |
|                                                                          |
|                                                                          |
| |image1| Posted by gaetano.giunta@ez.no at Mar 12, 2014 16:05            |
+--------------------------------------------------------------------------+
